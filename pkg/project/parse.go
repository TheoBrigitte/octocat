...
const (
	...
	localisationSelector  = "#prop-desc > div.prop-desc-localisation"
	themeSelector         = "#prop-header > span"
	likeSelector          = "#prop-data-actions > a > div.rating > p"
	followerSelector      = "#prop-data-actions > a > div.follow > p"
	popularSelector       = "#prop-data > div.pastilles > img"
	yearSelector          = "#prop-data > h2 + div > p"
	statusSelector        = "#prop-data > h2 + div + div > p"
	costSelector          = "#prop-data-cout > p"
	authorSelector        = "#prop-data-author > p"
	creationSelector      = "#prop-data-avatar"
	attachmentSelector    = "#prop-desc > div.prop-desc-pj > div > a"
	commentSelector       = "#comments > div.row > div > div.commentBlock.row"
